...
namespace Roster.Models
{
    ...
    public partial class AddressModel: BaseModel
    {
        ...
        public AddressModel(string name, string? unitNum, string streetNum, string streetName, string streetType, SuburbModel suburb, string city)
        {
            Name = name;
            UnitNum = unitNum;
            StreetNum = streetNum;
