...
namespace Roster.Models
{
    ...
    public abstract partial class PersonModel: BaseModel
    {
...
#nullable enable
        ...
        public PersonModel(string firstName, string lastName, string nickname, string gender)
        {
        ...
        public PersonModel(string firstName, string lastName, string nickname, string gender, string dob, string phone, string email, Color? highlightColor)
        {            
