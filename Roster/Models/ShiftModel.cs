...
namespace Roster.Models
{
    public partial class ShiftModel: BaseModel
    {
        ...
        public virtual AddressModel StartLocation { get; set; }

        [ForeignKey("EndAddressId")] // Shadow FK
        public virtual AddressModel EndLocation { get; set; }
        ...
        */
        ...
        private ObservableCollection<ShiftWorkerModel> _shiftWorkers;
        ...
        */
        ...
        public ShiftModel(string startTime, string endTime, byte travelTime, short maxTravelDistance, ShiftAddress startLocation, ShiftAddress endLocation, char shiftType, bool reocurring, ClientModel client)
        {                        
            StartTime = startTime;
            EndTime = endTime;
